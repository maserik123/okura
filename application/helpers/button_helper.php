...
{
    $li_btn_edit    = '<button class="btn btn-mini btn-info" title="Edit Data" onClick=' . $btn_edit . '><li class="icon-pencil"></li></button>';
    $li_btn_delete  = '<button class="btn btn-mini btn-danger" title="Hapus Data" onClick=' . $btn_delete . '><li class="icon-trash"></li></button>';
    return '<div class="text-center">' . $li_btn_edit . $li_btn_delete . '</div>';
}

function get_btn_group2($btn_change_pic, $btn_edit, $btn_delete)
{
    $li_btn_cp    = '<button class="btn btn-mini btn-success" title="Change Pictures" onClick=' . $btn_change_pic . '><li class="icon-picture"></li></button>';
    $li_btn_edit    = '<button class="btn btn-mini btn-info" title="Edit Data" onClick=' . $btn_edit . '><li class="icon-pencil"></li></button>';
    $li_btn_delete  = '<button class="btn btn-mini btn-danger" title="Hapus Data" onClick=' . $btn_delete . '><li class="icon-trash"></li></button>';
    return '<div class="text-center">' . $li_btn_cp . $li_btn_edit . $li_btn_delete . '</div>';
}

function get_btn_verifikasi1($btn_edit, $btn_delete)
{
    $li_btn_edit    = '<button class="btn btn-mini btn-primary" title="Terima Verifikasi" onClick=' . $btn_edit . '><li class="icon-ok"></li>  </button>';
    $li_btn_delete  = '<button class="btn btn-mini btn-warning" title="Tolak Verifikasi" onClick=' . $btn_delete . '><li class="icon-remove"></li>  </button>';
    return '<div class="text-center">' . $li_btn_edit . $li_btn_delete . '</div>';
}
