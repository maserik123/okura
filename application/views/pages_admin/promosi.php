...
<script>
    document.addEventListener("DOMContentLoaded", function(event) {
        table = $('#data').DataTable({
            ...
            "dataType": 'JSON',
            "ajax": {
                "url": "<?php echo site_url('administrator/promosi/getAllData') ?>",
                "type": "POST",
                "data": {
    ...
    function ubah(id) {
        ...
        $('.form-group').removeClass('has-error')
            ...
            .find('#text-error').remove();
        $.ajax({
            url: "<?php echo site_url('administrator/promosi/getById/'); ?>/" + id,
            type: "GET",
            dataType: "JSON",
    ...
    function hapus(id) {
        swal({
            ...
            function() {
                $.ajax({
                    url: "<?php echo site_url('administrator/promosi/delete'); ?>/" + id,
                    type: "POST",
                    dataType: "JSON",
                    data: {
                        '<?php echo $this->security->get_csrf_token_name(); ?>': '<?php echo $this->security->get_csrf_hash(); ?>'
    ...
    function simpan() {
        ...
        var url;
        if (save_method == 'add') {
            url = '<?php echo base_url() ?>administrator/promosi/addData';
        } else if (save_method == 'update') {
            url = '<?php echo base_url() ?>administrator/promosi/update';
        }
        swal({
...
<div id="content-header">
    <div id="breadcrumb"> <a href="<?php echo base_url('administrator') ?>" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home </a> Promosi</div>
</div>
<!--End-breadcrumbs-->
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <select name="id_gambar" id="id_gambar" class="form-control" required>
                                ...
                                <?php foreach ($getGambarByPromosi as $row) { ?>
