        ...
        <nav class="navbar navbar-expand-lg">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <?php include 'elements_portal/navbar_tiket.php'; ?>
                </div>
            </div>
        </nav>
    </header>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="inner-content">
                        <p> <strong>Taman Bunga Impian Okura - Designed By: <a rel="nofollow noopener" href="https://templatemo.com" target="_blank">PT Fima Jaya</a></strong></p>
                        <p> <strong>Copyright <?php echo date('Y'); ?></strong></p>
                    </div>
                </div>
            </div>
        </div>
