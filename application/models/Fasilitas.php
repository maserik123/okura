...
class Fasilitas extends CI_Model
{
    ...
    public function getGambarByFasilitas()
    {
        $this->db->select('*');
        $this->db->from('gambar');
        $this->db->where('jenis', 'Fasilitas');
    ...
    {
        return $this->db->get_where('fasilitas ap', array('ap.id' => $id))->result();
    }
